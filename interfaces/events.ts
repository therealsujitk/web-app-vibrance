...
export default class Events {
  ...
  static async getAll(
    ...
    let before_date, before_time, after_date, after_time
  ...
  async add(event: Event) {
    ...
    const queries = [
      ...
      {
        query:
          'INSERT INTO `events` (`day_id`, `category_id`, `room_id`, `title`, `description`, `image_id`, `team_size_min`, `team_size_max`, `start_time`, `end_time`, `cost`, `faculty_coordinator_name`, `faculty_coordinator_mobile`, `student_coordinator_name`, `student_coordinator_mobile`, `event_id`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
        options: (results: any[]) => [
          event.day_id,
          event.category_id,
          event.room_id,
  ...
  async edit(id: number, event: OrNull<Event>) {
    ...
    const queries = [
      ...
      {
        query:
          'UPDATE `events` SET `day_id` = ?, `category_id` = ?, `room_id` = ?, `title` = ?, `description` = ?, `image_id` = ?, `team_size_min` = ?, `team_size_max` = ?, `start_time` = ?, `end_time` = ?, `cost` = ?, `faculty_coordinator_name` = ?, `faculty_coordinator_mobile` = ?, `student_coordinator_name` = ?, `student_coordinator_mobile` = ?, `event_id` = ? WHERE `id` = ?',
        options: (results: any[]) => [
          event.day_id,
          event.category_id,
          event.room_id,
