            ...
            {({ initSession }) => (
              <Stack spacing={1} mt={0.5} mb={1}>
                <TextField
                  ...
                  inputProps={{ onKeyDown: this.handleEnter() }}
                ...
                <TextField
                  ...
                  inputProps={{ onKeyDown: this.handleEnter(initSession) }}
                ...
                {this.state.errorMessage && (
                  <Typography sx={{ textAlign: 'center', fontSize: 14, color: 'red' }} pt={0.5} variant="subtitle2">
                    {this.state.errorMessage}
                  </Typography>
                )}
                <Button
                  ...
                  onClick={() => this.signIn(initSession)}
                >
                  Sign In
                </Button>
                <Typography sx={{ textAlign: 'center' }} pt={1} variant="subtitle2">
                  Built by{' '}
                  <Link href="https://therealsuji.tk" underline="none" target="_blank">
                    @therealsujitk
                  </Link>
                </Typography>
              </Stack>
