...
export default class Home extends React.Component<{}, HomeState> {
  constructor(props: {}) {
    ...
    Object.entries(AppBar.items).map(([_, item]) => 'faIcon' in item && library.add(item.faIcon))

    Object.entries(Drawer.items).map(([_, item]) => 'faIcon' in item && library.add(item.faIcon))
  }
