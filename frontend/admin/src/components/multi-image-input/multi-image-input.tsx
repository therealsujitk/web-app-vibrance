    ...
    return (
      ...
      >
        ...
        {this.state.images.length !== 0 && (
          ...
          >
            {this.state.images.length < this.props.files && (
              <Box
                sx={(theme) => ({
                  width: '75px',
                  height: '75px',
            ...
            {imageData.map((i, x) => (
              <Box
                ...
                sx={(theme) => ({
                  ...
                  borderRadius: `${theme.shape.borderRadius}px`,
                  border: '2px solid',
                  borderColor: selectedIndex === x ? theme.palette.primary.main : 'transparent',
                  marginTop: '10px',
                  transition: 'border-color 0.3s',
                  '&:hover': {
                    cursor: 'pointer',
        ...
        >
          <Box
            sx={(theme) => ({
              height: '100%',
              flexGrow: 1,
              backgroundImage: `url(${selectedIndex === -1 ? '' : imageData[selectedIndex]})`,
