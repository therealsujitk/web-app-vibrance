...
import { Box, Button as MaterialButton, CircularProgress, DialogContent, Grid, IconButton, Menu, MenuItem, Paper, Stack, Tooltip, Typography } from "@mui/material";
      ...
      <>
        ...
        <Theme>
          {(theme) => <AnalyticsLineChart
            ...
            type={this.state.analyticsData![this.state.selectedAnalyticsIndex].name.includes('duration') ? 'duration' : 'number'}
          />}
        </Theme>
      </>
    );
          ...
          <DialogContent>
            <Stack spacing={2} mt={0.5}>
              ...
              <Button 
                ...
                onClick={() => {
                  setLoading(true);
                  this.deleteItem(0).then(_ => onClose()).finally(() => setLoading(false));
                }}
        ...
        <DialogContent>
          <form ref={this.formRef} onSubmit={(event) => event.preventDefault()}>
            <Stack spacing={1}>
              ...
              <TextArea name="ga_private_key" placeholder="Google Analytics Data API Private Key" sx={{minHeight: 200}} />
              <Button 
                type="submit" 
                isLoading={isDashboardLoading} 
                variant="contained" 
            ...
            <Stack spacing={2}>
              ...
              <Paper sx={{ p: 3 }}>
                <Box sx={{ width: '100%', display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  {!this.state.isLoading && <Tooltip title="Configure Analytics">
